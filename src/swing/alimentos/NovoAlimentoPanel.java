...
public class NovoAlimentoPanel extends JPanel {
	...
	public NovoAlimentoPanel() {
		...
		fldCarboidratos = new JTextField();
	...
	private final ActionListener ok = new ActionListener() {
		public void actionPerformed(ActionEvent arg0) {
			...
			if(!erro) {
				...
				Sistema.getAlimentos().add(new Alimento(nome, calorias, carboidratos, gorduras, porcao, proteina, sodio));
